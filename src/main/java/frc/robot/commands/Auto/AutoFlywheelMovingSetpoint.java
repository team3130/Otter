...
public class AutoFlywheelMovingSetpoint extends Command {
   ...
   */
  public AutoFlywheelMovingSetpoint(Shooter shooter) {
  ...
  public void initialize() {
    System.out.println("Command initialized: FlyMoving");
    timer.reset();
    timer.start();
  ...
  public void end(boolean interrupted) {
    ...
    if (interrupted) {
      System.out.println("Command interrupted: Fly mogging");
    }
    System.out.println("Command finished: Fly mogging");
    timer.stop();
  }
